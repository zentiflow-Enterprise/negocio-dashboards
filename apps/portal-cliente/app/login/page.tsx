...
export default function LoginPage() {
    ...
    // Canvas animado (tu código original completo)
    useEffect(() => {
            ...
            <div className="zf-root">
                ...
                <div className="zf-card">
                    ...
                    <div className="text-center mt-6 space-y-2 text-sm">
                        <Link href="/signup" className="block text-[var(--accent)] hover:underline">
                            ¿No tienes cuenta? Crear cuenta
                        </Link>
                        <Link href="/forgot-password" className="block text-[var(--text-soft)] hover:text-[var(--accent)]">
